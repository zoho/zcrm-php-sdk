...
class ZCRMRecord {
  ...
  public function getRelatedListRecords($relatedListAPIName, $sortByField = NULL, $sortOrder = NULL, $page = 1, $perPage = 20) {
    return ZCRMModuleRelation::getInstance($this, $relatedListAPIName)
      ->getRecords($sortByField, $sortOrder, $page, $perPage);
  }

  public function getNotes($sortByField = NULL, $sortOrder = NULL, $page = 1, $perPage = 20) {
    return ZCRMModuleRelation::getInstance($this, "Notes")
      ->getNotes($sortByField, $sortOrder, $page, $perPage);
  }
  ...
  public function addRelation(ZCRMJunctionRecord $junctionRecord) {
    return ZCRMModuleRelation::getInstance($this, $junctionRecord)
      ->addRelation();
  }
